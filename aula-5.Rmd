...
Po exemplo, o valor médio de $\mu = E[X]$ pode ser estimado da seguinte forma:
...
Um intervalo de confiança para $\mu = E[T]$ de grau aproximadamente 2 é dado pela relação
$$
...
$$
  T_{1:N} \leq T_{2:N} \leq \dotsm \leq T_{N:N}
$$
O quantil $p$ da estatística $T$ será estimad (para um $n$ fixo) por
$$
